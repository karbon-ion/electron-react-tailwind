      ...
      <ul>
        {chat.map((message) => (
          <li key={message.id} className="mb-2">
            <div
              className={`${message.sender === 'You' ? 'text-right' : 'text-left'
                }`}
            >
          ...
          <div className="flex-shrink-0 w-20 bg-green-800 flex flex-col items-center">
            ...
            <div className=" ps-4 pe-4">
              ...
              <button
                ...
                className={`p-2 text-white hover:bg-green-700 focus:outline-none mt-4 ${activeSection === 'chat' ? 'bg-green-700' : ''
                  }`}
              >
                chats
              </button>
              <button
                ...
                className={`p-2 text-white hover:bg-green-700 focus:outline-none mt-4 ${activeSection === 'contacts' ? 'bg-green-700' : ''
                  }`}
              >
                Contacts
              </button>
              <button
                ...
                className={`p-2 text-white hover:bg-green-700 focus:outline-none mt-4 ${activeSection === 'groups' ? 'bg-green-700' : ''
                  }`}
              >
                Groups
              </button>
